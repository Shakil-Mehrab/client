...
<main id="main" class="tg-haslayout">
				...
				<div class="container">
					...
					<div class="tg-aboutus-section">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<figure class="tg-about-img"><img src="images/img-06.png" alt="image description"></figure>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<div id="tg-skill-team-slider" class="tg-skill-team-slider">
										...
										<div class="tg-ourteam tg-about-us tg-haslayout">
											<div class="tg-teammember tg-haslayout">
												<figure class="tg-member-img">
													<a href="#"><img alt="member name" src="images/our-team/img-01.jpg"></a>
									...
									<div class="item">
										<div class="tg-ourteam tg-about-us tg-haslayout">
											<div class="tg-teammember tg-haslayout">
												<figure class="tg-member-img">
													<a href="#"><img alt="member name" src="images/our-team/img-02.jpg"></a>
													<div class="tg-member-hover">
														<ul class="tg-member-hover-icons">
															<li><a href="#"><i class="flaticon-plus79"></i></a></li>
															<li><a href="#"><i class="flaticon-share55"></i></a></li>
									...
									<div class="item">
										<div class="tg-ourteam tg-about-us tg-haslayout">
											<div class="tg-teammember tg-haslayout">
												<figure class="tg-member-img">
													<a href="#"><img alt="member name" src="images/our-team/img-03.jpg"></a>
													<div class="tg-member-hover">
														<ul class="tg-member-hover-icons">
															<li><a href="#"><i class="flaticon-plus79"></i></a></li>
															<li><a href="#"><i class="flaticon-share55"></i></a></li>
									...
									<div class="item">
										<div class="tg-ourteam tg-about-us tg-haslayout">
											<div class="tg-teammember tg-haslayout">
												<figure class="tg-member-img">
													<a href="#"><img alt="member name" src="images/our-team/img-04.jpg"></a>
													<div class="tg-member-hover">
														<ul class="tg-member-hover-icons">
															<li><a href="#"><i class="flaticon-plus79"></i></a></li>
															<li><a href="#"><i class="flaticon-share55"></i></a></li>
							...
							<div class="tg-haslayout tg-reviews">
								...
								<div id="tg-review-slider" class="tg-review-slider tg-haslayout">
									<div class="tg-review tg-haslayout">
										...
										<figure class="tg-reviewer-img"><img src="images/thumbnail/img-09.jpg" alt="image description"></figure>
									</div>
									<div class="tg-review tg-haslayout">
										<div class="tg-review-content">
											<div class="tg-reviewer-head tg-haslayout">
										...
										<figure class="tg-reviewer-img"><img src="images/thumbnail/img-10.jpg" alt="image description"></figure>
									</div>
								</div>
							</div>
						</div>
			...
			*************************************-->
			<!--************************************
					Testimonials Start
			*************************************-->
			<section class="tg-main-section tg-haslayout parallax-window" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/parallax-img/bg-parallax-02.jpg">
				<div class="container">
					<div class="row">
					...
					<div class="row">
						<div class="tg-brands tg-haslayout">
							<div class="col-sm-3 col-xs-3 width-360">
								<figure><a href="#"><img src="images/brand-01.png" alt="brand name"></a></figure>
							</div>
							<div class="col-sm-3 col-xs-3 width-360">
								<figure><a href="#"><img src="images/brand-02.png" alt="brand name"></a></figure>
							</div>
							<div class="col-sm-3 col-xs-3 width-360">
								<figure><a href="#"><img src="images/brand-03.png" alt="brand name"></a></figure>
							</div>
							<div class="col-sm-3 col-xs-3 width-360">
								<figure><a href="#"><img src="images/brand-04.png" alt="brand name"></a></figure>
							</div>
						</div>
					</div>
				</div>
